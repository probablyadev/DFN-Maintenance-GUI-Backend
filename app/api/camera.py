...
from command.camera import turn_camera_off, turn_camera_on, camera_status, download_thumbnail, download_picture, \
    find_pictures, remove_thumbnail, turn_video_camera_off, turn_video_camera_on
