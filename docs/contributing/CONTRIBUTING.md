# Contributing to Desert Fireball Maintenence GUI
...
The [issue tracker](https://github.com/ScottDay/Desert-Fireball-Maintainence-GUI/issues) is
...
`development` branch that unstable changes get merged into first. Only when we
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/Desert-Fireball-Maintainence-GUI.git
   # Navigate to the newly cloned directory
   cd Desert-Fireball-Maintainence-GUI
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/ScottDay/Desert-Fireball-Maintainence-GUI.git
   ```
